...
3. Select `IOS-ANCS-<FAMILY>-<SUFFIX>` when it appears, such as `IOS-ANCS-C6-AB12`.
4. Enter PIN `123456`.
...
- **Enroll** opens pairing only when no bond exists. With a stored bond it is reconnect-only and rejects unknown phones.

...
the stable unique ID `ios_ancs_c6_2b20:binary_sensor:ble_connected`; do not infer
the entity ID from translated names. Expected live assertions:

```text
the registry entry with unique ID ios_ancs_c6_2b20:binary_sensor:ble_connected exists

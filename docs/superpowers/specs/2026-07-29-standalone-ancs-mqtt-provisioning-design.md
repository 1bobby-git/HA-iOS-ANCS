...
5. Home Assistant가 MQTT 알림을 `notify.mobile_app_example_phone`로 한 번만 전달한다.
...
- 현재 장치 SSID: `IOS-ANCS-SETUP-ABC123`
- WPA2 비밀번호: `ANCS-<MAC 끝 3바이트>`
- 현재 장치 비밀번호: `ANCS-ABC123`
- AP 주소: `192.168.4.1`
- DHCP: 활성
...
- Enroll 창에서 HID GATT 서비스 준비 후 `IOS-ANCS-C6-AB12`을 광고한다.

const boards = {
  esp32: {
    ...
    name: "ESP32 / WROOM-32",
    boot: "GPIO 0",
    validation: "v0.3.4 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32/WROOM-32 계열용 v0.3.4 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 F52165844888",
  },
  esp32c2: {
    chip: "C2",
    name: "ESP32-C2",
    ...
    validation: "v0.3.4 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C2 계열용 v0.3.4 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 A66E7D02D35D",
  },
  esp32c3: {
    chip: "C3",
    name: "ESP32-C3",
    ...
    validation: "v0.3.4 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C3 계열용 v0.3.4 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 29D5AC6C6015",
  },
  esp32c5: {
    chip: "C5",
    name: "ESP32-C5",
    ...
    validation: "v0.3.4 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C5 계열용 v0.3.4 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 532B83495F97",
  },
  esp32c6: {
    chip: "C6",
    name: "ESP32-C6",
    ...
    validation: "v0.3.4 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C6 계열용 v0.3.4 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 24740619D9A3",
  },
  esp32c61: {
    chip: "C61",
    name: "ESP32-C61",
  ...
  esp32s3: {
    ...
    validation: "v0.3.4 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-S3 계열용 v0.3.4 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 B602A8F5907C",
  },
};

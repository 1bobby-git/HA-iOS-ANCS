const boards = {
  esp32: {
    ...
    name: "ESP32 / WROOM-32",
    boot: "GPIO 0",
    validation: "v0.3.5 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32/WROOM-32 계열용 v0.3.5 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 0FA391F1BAFE",
  },
  esp32c2: {
    chip: "C2",
    name: "ESP32-C2",
    ...
    validation: "v0.3.5 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C2 계열용 v0.3.5 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 99CEAF52F87B",
  },
  esp32c3: {
    chip: "C3",
    name: "ESP32-C3",
    ...
    validation: "v0.3.5 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C3 계열용 v0.3.5 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 EB27F5735F8B",
  },
  esp32c5: {
    chip: "C5",
    name: "ESP32-C5",
    ...
    validation: "v0.3.5 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C5 계열용 v0.3.5 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 16C1D902FCAA",
  },
  esp32c6: {
    chip: "C6",
    name: "ESP32-C6",
    ...
    validation: "v0.3.5 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C6 계열용 v0.3.5 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 8585084E0B4B",
  },
  esp32c61: {
    chip: "C61",
    name: "ESP32-C61",
  ...
  esp32s3: {
    ...
    validation: "v0.3.5 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-S3 계열용 v0.3.5 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 BC1AF816921E",
  },
};

const boards = {
  esp32: {
    ...
    name: "ESP32 / WROOM-32",
    boot: "GPIO 0",
    validation: "v0.3.8 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32/WROOM-32 계열용 v0.3.8 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 E16E79299560",
  },
  esp32c2: {
    chip: "C2",
    name: "ESP32-C2",
    ...
    validation: "v0.3.8 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C2 계열용 v0.3.8 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 BE4AC71064F8",
  },
  esp32c3: {
    chip: "C3",
    name: "ESP32-C3",
    ...
    validation: "v0.3.8 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C3 계열용 v0.3.8 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 23D77770F0A4",
  },
  esp32c5: {
    chip: "C5",
    name: "ESP32-C5",
    ...
    validation: "v0.3.8 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C5 계열용 v0.3.8 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 4CDEFCAFD531",
  },
  esp32c6: {
    chip: "C6",
    name: "ESP32-C6",
    ...
    validation: "v0.3.8 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C6 계열용 v0.3.8 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 4388FD1E504D",
  },
  esp32c61: {
    chip: "C61",
    name: "ESP32-C61",
  ...
  esp32s3: {
    ...
    validation: "v0.3.8 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-S3 계열용 v0.3.8 ANCS-to-MQTT factory build입니다.",
    hash: "SHA256 CF1E90884792",
  },
};

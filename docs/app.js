const boards = {
  esp32: {
    ...
    description: "ESP32/WROOM-32 계열용 v0.3.3 ANCS-to-MQTT factory build입니다.",
  ...
  esp32c2: {
    ...
    validation: "v0.3.3 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C2 계열용 v0.3.3 ANCS-to-MQTT factory build입니다.",
  ...
  esp32c3: {
    ...
    validation: "v0.3.3 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C3 계열용 v0.3.3 ANCS-to-MQTT factory build입니다.",
  ...
  esp32c5: {
    ...
    validation: "v0.3.3 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C5 계열용 v0.3.3 ANCS-to-MQTT factory build입니다.",
  ...
  esp32c6: {
    ...
    validation: "v0.3.3 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-C6 계열용 v0.3.3 ANCS-to-MQTT factory build입니다.",
  ...
  esp32s3: {
    ...
    validation: "v0.3.3 build verified",
    status: "BUILD VERIFIED",
    description: "ESP32-S3 계열용 v0.3.3 ANCS-to-MQTT factory build입니다.",

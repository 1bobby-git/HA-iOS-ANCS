...
The known test board has base MAC suffix `ABC123`. Its provisioning AP is `IOS-ANCS-SETUP-ABC123` with password `ANCS-ABC123`. Other boards derive both values from the last three MAC bytes as `IOS-ANCS-SETUP-<SUFFIX>` and `ANCS-<SUFFIX>`.

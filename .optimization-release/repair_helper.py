"""Apply a verified correction to the pinned one-time release publisher."""
...
print('Verified publisher correction: draft-by-ID lookup, SHA-256 and latest-release checks')

"""Correct the pinned publisher without weakening source or release gates."""
...
# Include the Path constructor to select the write loop, not the AST-check loop.
...
print('Verified publisher: draft-by-ID, SHA-256, latest-release checks and document-only EOF normalization')
